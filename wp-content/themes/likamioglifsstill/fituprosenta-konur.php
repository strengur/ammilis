...
/* Template Name: Fituprósenta Konur */
		...
		<form action="" target="" method="post">
			<div>
				...
				<label><b>Aldur: </b></label><input id="aldur" class="aldur" name="aldur" size="1">&nbsp;ára/s</td>
						...
						<tr>
							<td colspan="5" align="center"><input type="submit" name="submit" value="Reikna fituprósentu..."><br/>
							</td>
						</tr>
					</tbody>
				</table>
...
if (isset($_POST['submit']))
	{
	$magi = $_POST['magi'];
	$thrihofdi = $_POST['thrihofdi'];
	$laeri = $_POST['laeri'];
	$aldur = $_POST['aldur'];


$sum = $magi + $thrihofdi + $laeri;

$density1 = '0.0009929' * $sum;
$density2 = '1.0994921' - $density1;

$density3 = $sum * $sum;
$density4 = '0.0000023' * $density3;

$density5 = '0.0001392' * $aldur;
